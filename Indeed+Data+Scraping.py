...
career = raw_input("Enter the Job:") #use raw_input because input just takes the python expression and does eval on them
...
with open('C:\\Users\\msasi\\Desktop\\index.csv','a') as csv_file:
...
datas = pd.read_csv('C:\\Users\\msasi\\Desktop\\index.csv', parse_dates=True)
datas.head()
